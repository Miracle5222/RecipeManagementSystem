        ...
        <div class="container d-flex justify-content-center align-items-center" style="height:80vh;">
            <div class="error-box">
                <div class="error-body text-center">
                    ...
                    <p class="text-muted m-t-30 m-b-30">YOU NEED TO SIGN-IN FIRST</p>
                    <a href="../index.php" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40 text-white">Back to home</a>
                    <a href="login.php" class="btn btn-info btn-rounded waves-effect waves-light m-b-40 text-white">Sign-In</a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
