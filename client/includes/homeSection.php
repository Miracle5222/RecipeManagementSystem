            ...
            <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
                ...
                <div class="carousel-inner ">
                    <div class="carousel-item active">
                        ...
                        <!-- <img class="d-block w-100 " src="./assets/images/f1.jpg" alt="First slide"> -->
                    </div>
                    <div class="carousel-item">
                        <div class="box1">
                            <img class="d-block w-100 images" src="./assets/images/f2.jpg" alt="Second slide">
                        </div>
                        <!-- <img class="d-block w-100 " src="./assets/images/f2.jpg" alt="Second slide"> -->
                    </div>
                    <div class="carousel-item">
                        <div class="box1">
                            <img class="d-block w-100 images" src="./assets/images/f3.jpg" alt="Third slide">
                        </div>
                        <!-- <img class="d-block w-100 img-fluid" src="./assets/images/f3.jpg" alt="Third slide"> -->
                    </div>
                </div>
