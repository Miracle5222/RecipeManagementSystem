                    ...
                    <div class="row bg-light p-4">
                        ...
                        <table id="example" class="display " style="width:100%">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM userrecipe_tbl INNER JOIN recipe_tbl ON recipe_tbl.`recipe_id` = userrecipe_tbl.`recipe_id` INNER JOIN user_tbl ON user_tbl.`user_id` = userrecipe_tbl.`user_id` where recipe_tbl.status = 'Pending...'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center flex-row ">
                                                    <a href="./process/updateRecipe.php?id=<?= $row['recipe_id'] ?>" class="mx-2 btn btn-info">Confirm</a>
                                                    <a onclick="return confirm('are you sure you want to reject this recipe?')" href="./process/rejectRecipe.php?recipe_id=<?= $row['recipe_id'] ?>" class="mx-2   btn btn-danger text-white">Reject</a>
