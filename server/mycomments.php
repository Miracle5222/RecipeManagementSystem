                ...
                <div class="row ">
                    <div class="col-md-12">
                        ...
                        if (isset($_GET['delete'])) {
                            $id = $_GET['delete'];
                            $sql = "delete from mycomments_tbl WHERE userComment_Id='$id'";
                    ...
                    <div class="row bg-light p-4">
                        ...
                        <table id="example" class="display " style="width:100%">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT mycomments_tbl.`userComment_Id`,mycomments_tbl.`mycomment`,user_tbl.`username`,mycomments_tbl.`comment_date` FROM mycomments_tbl INNER JOIN comment_tbl ON comment_tbl.`comment_id` = mycomments_tbl.`comment_id` INNER JOIN user_tbl ON user_tbl.`user_id` = mycomments_tbl.`user_id`;";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center flex-row ">
                                                    ...
                                                    <a onclick="return confirm('delete this comment?')" href="./mycomments.php?delete=<?= $row['userComment_Id'] ?>" class="mx-2   btn btn-danger text-white">Delete</a>
